...
namespace AspCoreApiTemplate.Services
{
    public class AuthenticateService : IAuthenticateService
    {
        ...
        public AuthenticateService(ILogger<AuthenticateService> logger, UserManager<AuthorityUser> userManager, SignInManager<AuthorityUser> signInManager, IConfiguration config, IOptions<AppSettings> appSettings, ICredentialHandler credentialHandler)
        {
            this.logger = logger;
                ...
                try
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        try
                        {
                            ...
                            //                       //this way, our token will contain enough information to tie together the current user in the API to the actual AspCoreApiTemplateUser that we need for the relational model
        ...
        public Task<string> EncryptStringAES(string plainText)
        {
            return credentialHandler.DecryptStringAES(plainText, appSettings.EncryptionDecryptionKey);
        }
