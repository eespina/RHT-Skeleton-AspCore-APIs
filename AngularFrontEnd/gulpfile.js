...
var paths = {
    //js: 'site/src/js/*.js',   //PROBABLY UNNECCESSARY Javascript (now handled by TypeScript)
    //   jsConcatSrc: ['!site/src/js/scripts.concat.js', 'site/src/js/*.js'],  //PROBABLY UNNECCESSARY Javascript (now handled by TypeScript)
    //jsDist: 'dist/js',    //PROBABLY UNNECCESSARY Javascript (now handled by TypeScript)
    //   jsSrc: 'site/src/js', //PROBABLY UNNECCESSARY Javascript (now handled by TypeScript)
    ...
    cssDist: 'dist/css',
    cssSrc: 'site/src/css',
    cssWatch: 'site/src/styl/**/*.styl',
    cssWatch2: 'site/src/styl/**/**/*.styl',
    cssMinFilename: 'main.min.css',
    cssConcatFilename: 'main.concat.css',
    cssStylFilename: '_main-styl.scss',
    //fonts: 'site/src/fonts/**/*',
    //fontsSrc: 'site/src/css/fonts',
    mainStyl: 'site/src/styl/main.styl'//,
...
gulp.task('sass', function () {
    return gulp.src('site/src/sass/main.scss')
        .pipe(sass())
        .pipe(stripCss())
...
gulp.task('prefix', function () {
    return gulp.src('site/src/css/main.concat.css')
        .pipe(autoprefixer({
