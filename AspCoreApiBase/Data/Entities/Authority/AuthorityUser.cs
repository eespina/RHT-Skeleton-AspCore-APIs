...
namespace AspCoreBase.Data.Entities.Authority
{
	...
	//aslo, inthis example, we need to tie the Entity peice in to the order system by going into Order.cs and adding the 'public StoreUser User { get; set; }' property
